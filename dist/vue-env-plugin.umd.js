(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["vue-env-plugin"] = factory();
	else
		root["vue-env-plugin"] = factory();
...
var Case = __webpack_require__("8037");
...
/* harmony default export */ var src_0 = ({
  install: function install(Vue) {
    var env = _objectSpread2({}, Object({"NODE_ENV":"production","BASE_URL":"/"}));

    var vueAppShortcuts = lodash_default()(env).pickBy(function (_, k) {
      return k.startsWith('VUE_APP_');
    }).mapKeys(function (_, k) {
      return k.substring(8);
    }).value();

    var camelCase = lodash_default.a.mapKeys(_objectSpread2(_objectSpread2({}, env), vueAppShortcuts), function (_, k) {
      if (Object(Case["of"])(k) === 'constant') {
        return Object(Case["camel"])(k);
      }

      return k;
    });

    Vue.prototype.$env = _objectSpread2(_objectSpread2(_objectSpread2({}, env), vueAppShortcuts), camelCase);
  }
});
